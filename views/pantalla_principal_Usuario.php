...
<head>
    ...
    <link rel="stylesheet" href="../public/css/dropdown_usuario.css?v=<?php echo time(); ?>">
</head>
...
<body>
    ...
    <!-- información del usuario, funciona con el js de abajo -->
    ...
    <main class="container">
        ...
        <section class="bottom-panel">
            ...
            <div class="medals-section">
                ...
                <a href="../views/logros.php" class="btn small">Ver logros</a>
            </div>
        </section>
    </main>
